...
import com.studio216.fbs.SurplusActivity;
 ...
 */
public class SurplusActivityHandle extends Handler {
    private Context context;
    private SurplusActivity activity;

    public SurplusActivityHandle(SurplusActivity activity, Context context) {

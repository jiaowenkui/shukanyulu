...
public class InternalData implements Serializable{
    ...
    public InternalData(String inter1DCode, String interISBN, String interName, String interAuthors, String interPublic, Date interPublicDate, String interContent, String interIsBorrow, String interPlace, String interImage) {
    ...
    public String toString() {
        return "类别:   内部数据\n" +
                ...
                "数据主要内容:   " + interContent + "\n" +
                "数据出版社:   " + interPublic + "\n" +
                "数据出版日期:   " + interPublicDate + "\n" +
                "数据是否借出:   " + interIsBorrow + "\n" +
                "数据位置" + interPlace;
    }
}
